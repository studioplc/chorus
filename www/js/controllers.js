angular.module("chorus.controllers", [])
...
.controller("indexCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.changeLanguage = function(langKey){
		if(typeof langKey !== null){
			...
			try {
				...
				localforage.setItem("language_option","fr");
			}
		}
	};
	...
	modal_language += "<ion-header-bar class=\"bar bar-header bar-assertive-900\">";
	...
	modal_language += "<ion-radio icon=\"icon ion-android-radio-button-on\" ng-model=\"language_option\" ng-value=\"'fr'\" ng-click=\"tryChangeLanguage('fr')\">French</ion-radio>";
	modal_language += "<button class=\"button button-full button-assertive-900\" ng-click=\"closeLanguageDialog()\">{{ 'Close' | translate }}</button>";
	modal_language += "</div>";
	...
	modal_fontsize += "<ion-header-bar class=\"bar bar-header bar-assertive-900\">";
	...
	modal_fontsize += "<button class=\"button button-full button-assertive-900\" ng-click=\"closeFontSizeDialog()\">{{ 'Close' | translate }}</button>";
	modal_fontsize += "</div>";
	...
	modal_notification += "<ion-header-bar class=\"bar bar-header bar-assertive-900\">";
	...
	modal_notification += "<button class=\"button button-full button-assertive-900\" ng-click=\"closeNotificationDialog()\">{{ 'Close' | translate }}</button>";
...
.controller("side_menusCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/chorus/about_us\" ng-click=\"popover.hide()\">";
	popover_template += "			{{ 'Qui sommes-nous ?' | translate }}";
	popover_template += "			</a>";
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/chorus/tarifs\" ng-click=\"popover.hide()\">";
	popover_template += "			{{ 'Tarifs' | translate }}";
	popover_template += "			</a>";
	popover_template += "		</ion-list>";
	popover_template += "	</ion-content>";
...
// TODO: actualitesCtrl --|-- 
.controller("actualitesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: actualitesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: actualitesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: actualitesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: actualitesCtrl --|-- $scope.showAuthentication
	...
	// TODO: actualitesCtrl --|-- $scope.splitArray
	...
	// TODO: actualitesCtrl --|-- $scope.addToVirtual
	$scope.addToDbVirtual = function(newItem){
		var is_already_exist = false ;
		// animation loading 
		$ionicLoading.show();
		var virtual_items = []; 
		localforage.getItem("actualites_bookmark", function(err,dbVirtual){
			if(dbVirtual === null){
				virtual_items = [];
			}else{
				try{
			...
			localforage.setItem("actualites_bookmark",JSON.stringify(virtual_items));
			$timeout(function(){
				$ionicLoading.hide();
			},200);
		}).catch(function(err){
	...
	// TODO: actualitesCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://www.chorus.hk//wp-json/wp/v2/posts/?_embed&categories=31&per_page=12&page=1";
	// TODO: actualitesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://www.chorus.hk//wp-json/wp/v2/posts/?_embed&categories=31&per_page=12&page=1&callback=JSON_CALLBACK";
	// TODO: actualitesCtrl --|-- $scope.hashURL
	...
	var lastPush = 0;
	var data_actualitess = [];
	
	localforage.getItem("data_actualitess_" + $scope.hashURL, function(err, get_actualitess){
		if(get_actualitess === null){
			data_actualitess =[];
		}else{
			data_actualitess = JSON.parse(get_actualitess);
			$scope.data_actualitess =JSON.parse( get_actualitess);
			$scope.actualitess = [];
			for(lastPush = 0; lastPush < 100; lastPush++) {
				if (angular.isObject(data_actualitess[lastPush])){
					$scope.actualitess.push(data_actualitess[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_actualitess === null ){
		data_actualitess =[];
	}
	if(data_actualitess.length === 0 ){
		$timeout(function() {
			...
			// TODO: actualitesCtrl --|-- $http.get
			$http.get(url_request,http_header).then(function(response) {
				data_actualitess = response.data;
				$scope.data_actualitess = response.data;
				// TODO: actualitesCtrl --|---------- set:localforage
				localforage.setItem("data_actualitess_" + $scope.hashURL, JSON.stringify(data_actualitess));
				$scope.actualitess = [];
				for(lastPush = 0; lastPush < 100; lastPush++) {
					if (angular.isObject(data_actualitess[lastPush])){
						$scope.actualitess.push(data_actualitess[lastPush]);
				...
				$timeout(function() {
					...
					// TODO: actualitesCtrl --|------ $http.jsonp
					$http.jsonp(url_request,http_header).success(function(data){
						data_actualitess = data;
						$scope.data_actualitess = data;
						$ionicLoading.hide();
						// TODO: actualitesCtrl --|---------- set:localforage
						localforage.setItem("data_actualitess_" + $scope.hashURL,JSON.stringify(data_actualitess));
						controller_by_user();
					...
					if(response.status ===401){
						// TODO: actualitesCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: actualitesCtrl --|------------ error:Message
			...
			$timeout(function() {
				$ionicLoading.hide();
				controller_by_user();
				if(angular.isDefined($scope.data_actualitess.data)){
					if($scope.data_actualitess.data.status ===401){
						$scope.showAuthentication();
						return false;
					}
				}
	...
	// TODO: actualitesCtrl --|-- $scope.doRefresh
	...
	// TODO: actualitesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
var UriListing = "http://www.chorus.hk//wp-json/wp/v2/posts?_embed&categories=31&per_page=10";    
...
$scope.updatePaging=function(ev){
    ...
    $timeout(function() {
        $scope.scrollTop();
			...
			console.log("%cerror: %cPage: `actualites` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: actualites_bookmarkCtrl --|-- 
.controller("actualites_bookmarkCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: actualites_bookmarkCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: actualites_bookmarkCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: actualites_bookmarkCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: actualites_bookmarkCtrl --|-- Database for Cart/Bookmark
	// TODO: actualites_bookmarkCtrl --|-- $scope.loadDbVirtualActualites
	 
	$scope.loadDbVirtualActualites = function(){
		$ionicLoading.show();
		//actualites_bookmark
		$scope.actualites_bookmark = []; 
		localforage.getItem("actualites_bookmark", function(err,dbVirtual){
			if(dbVirtual === null){
				$scope.actualites_bookmark = []; 
			}else{
				try{
					$scope.actualites_bookmark = JSON.parse(dbVirtual); 
					$rootScope.item_in_virtual_table_actualites = $scope.actualites_bookmark.length;
				}catch (e){
					$scope.actualites_bookmark = []; 
				}
			}
	...
	$scope.$on("$ionicView.enter", function (){
		$scope.loadDbVirtualActualites();
	});
	// TODO: actualites_bookmarkCtrl --|-- $scope.clearDbVirtualActualites
	$scope.clearDbVirtualActualites = function(){
					$rootScope.item_in_virtual_table_actualites = 0;
		localforage.setItem("actualites_bookmark",[]);
		$timeout(function(){
			$scope.loadDbVirtualActualites();
		},200);
	};
	// TODO: actualites_bookmarkCtrl --|-- $scope.removeDbVirtualActualites
	$scope.removeDbVirtualActualites = function(itemId){
		var virtual_items = [];
		var last_items = $scope.actualites_bookmark;
		for(var z=0;z<last_items.length;z++){
	...
	// TODO: actualites_bookmarkCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
// TODO: actualites_singlesCtrl --|-- 
.controller("actualites_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: actualites_singlesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: actualites_singlesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: actualites_singlesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: actualites_singlesCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var form = {"uname":"demo","pwd":"demo"};
		$scope.form = {};
		var authPopup = $ionicPopup.show({
	...
	// TODO: actualites_singlesCtrl --|-- $scope.addToVirtual(); //data single
	$scope.addToDbVirtual = function(newItem){
		...
		localforage.getItem("actualites_bookmark", function(err,dbVirtual){
			...
			$timeout(function(){
				$ionicLoading.hide();
				$rootScope.item_in_virtual_table_actualites = virtual_items.length;
			},200);
		}).catch(function(err){
			virtual_items = [];
			virtual_items.push(newItem);
	...
	// TODO: actualites_singlesCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://www.chorus.hk//wp-json/wp/v2/posts/?_embed&categories=31&per_page=12&page=1";
	// TODO: actualites_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://www.chorus.hk//wp-json/wp/v2/posts/?_embed&categories=31&per_page=12&page=1&callback=JSON_CALLBACK";
	// TODO: actualites_singlesCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash($scope.fetchURL);
	
	var current_item = [];
	localforage.getItem("data_actualitess_" + $scope.hashURL, function(err, get_datas){
		if(get_datas === null){
			current_item = [];
		}else{
			if(get_datas !== null){
	...
	if( current_item.length === 0 ){
		...
		// TODO: actualites_singlesCtrl --|-- $http.get
		$http.get($scope.fetchURL,http_header).then(function(response) {
			// Get data single
			var datas = response.data;
			// TODO: actualites_singlesCtrl --|---------- set:localforage
			localforage.setItem("data_actualitess_"+ $scope.hashURL,JSON.stringify(datas));
			for (var i = 0; i < datas.length; i++) {
				if((datas[i].id ===  parseInt(itemID)) || (datas[i].id === itemID.toString())) {
					current_item = datas[i] ;
				}
		...
		// TODO: actualites_singlesCtrl --|-- $scope.doRefresh
	$scope.doRefresh = function(){
		// Retrieving data
		var itemID = $stateParams.id;
		var current_item = [];
		...
		$http.get($scope.fetchURL,http_header).then(function(response) {
			...
			// Error message
		// TODO: actualites_singlesCtrl --|---------- $http.jsonp
	...
	// TODO: actualites_singlesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `actualites_singles` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("bandsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: bandsCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: bandsCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: bandsCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
// TODO: chantCtrl --|-- 
.controller("chantCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: chantCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: chantCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: chantCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `chant` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: codingCtrl --|-- 
.controller("codingCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: codingCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: codingCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: codingCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: codingCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
// TODO: francaisCtrl --|-- 
.controller("francaisCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: francaisCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: francaisCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: francaisCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: francaisCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `francais` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: guitareCtrl --|-- 
.controller("guitareCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: guitareCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: guitareCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: guitareCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: guitareCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `guitare` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("mathsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: mathsCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: mathsCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: mathsCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `maths` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: philosophieCtrl --|-- 
.controller("philosophieCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: philosophieCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: philosophieCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: philosophieCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: philosophieCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `philosophie` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: physiquechimieCtrl --|-- 
.controller("physiquechimieCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: physiquechimieCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: physiquechimieCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: physiquechimieCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: physiquechimieCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `physiquechimie` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: tarifsCtrl --|-- 
.controller("tarifsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: tarifsCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: tarifsCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: tarifsCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: tarifsCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var authPopup = $ionicPopup.show({
	...
	// TODO: tarifsCtrl --|-- $scope.splitArray
	$scope.splitArray = function(items,cols,maxItem) {
		var newItems = [];
		if(maxItem == 0){
			maxItem = items.length;
	...
	// TODO: tarifsCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://www.chorus.hk/?per_page=20&page=1";
	// TODO: tarifsCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://www.chorus.hk/?per_page=20&page=1&callback=JSON_CALLBACK";
	// TODO: tarifsCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash( $scope.fetchURL.replace(targetQuery,raplaceWithQuery));
	...
	localforage.getItem("data_tarifss_" + $scope.hashURL, function(err, get_tarifss){
		if(get_tarifss === null){
			data_tarifss =[];
		}else{
			data_tarifss = JSON.parse(get_tarifss);
			$scope.data_tarifss =JSON.parse( get_tarifss);
			$scope.tarifss = [];
			for(lastPush = 0; lastPush < 100; lastPush++) {
				if (angular.isObject(data_tarifss[lastPush])){
					$scope.tarifss.push(data_tarifss[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_tarifss === null ){
		data_tarifss =[];
	}
	if(data_tarifss.length === 0 ){
		$timeout(function() {
			var url_request = $scope.fetchURL.replace(targetQuery,raplaceWithQuery);
			// overwrite HTTP Header 
			http_header = {
			...
			// TODO: tarifsCtrl --|-- $http.get
			$http.get(url_request,http_header).then(function(response) {
				data_tarifss = response.data;
				$scope.data_tarifss = response.data;
				// TODO: tarifsCtrl --|---------- set:localforage
				localforage.setItem("data_tarifss_" + $scope.hashURL, JSON.stringify(data_tarifss));
				$scope.tarifss = [];
				for(lastPush = 0; lastPush < 100; lastPush++) {
					if (angular.isObject(data_tarifss[lastPush])){
						$scope.tarifss.push(data_tarifss[lastPush]);
				...
				$timeout(function() {
					...
					// TODO: tarifsCtrl --|------ $http.jsonp
					$http.jsonp(url_request,http_header).success(function(data){
						data_tarifss = data;
						$scope.data_tarifss = data;
						$ionicLoading.hide();
						// TODO: tarifsCtrl --|---------- set:localforage
						localforage.setItem("data_tarifss_" + $scope.hashURL,JSON.stringify(data_tarifss));
						controller_by_user();
					...
					if(response.status ===401){
						// TODO: tarifsCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: tarifsCtrl --|------------ error:Message
						var data = { statusText:response.statusText, status:response.status };
						var alertPopup = $ionicPopup.alert({
							title: "Network Error" + " (" + data.status + ")",
							template: "An error occurred while collecting data.",
			...
			$timeout(function() {
				$ionicLoading.hide();
				controller_by_user();
				if(angular.isDefined($scope.data_tarifss.data)){
					if($scope.data_tarifss.data.status ===401){
						$scope.showAuthentication();
						return false;
					}
				}
	...
	// TODO: tarifsCtrl --|-- $scope.doRefresh
	$scope.doRefresh = function(){
		var url_request = $scope.fetchURL.replace(targetQuery,raplaceWithQuery);
		// retry retrieving data
		// overwrite http_header 
	...
	// TODO: tarifsCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `tarifs` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: theatreadulteCtrl --|-- 
.controller("theatreadulteCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: theatreadulteCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: theatreadulteCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: theatreadulteCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: theatreadulteCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `theatreadulte` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: theatreenfantCtrl --|-- 
.controller("theatreenfantCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: theatreenfantCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: theatreenfantCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: theatreenfantCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: theatreenfantCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `theatreenfant` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
